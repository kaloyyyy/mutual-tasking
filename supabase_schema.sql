...
\restrict MXd7CtGaCBZu8yVc5WzfS86HtaoabHu56yRASnaqdKZPWRuMlwgkbWRHVkCtAJT
...
--
-- Name: tasks tasks_project_id_slug_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: tasks_project_id_slug_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX tasks_project_id_slug_key ON public.tasks USING btree (project_id, slug);
...
--
-- Name: projects projects_owner_id_fkey1; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.projects
    ADD CONSTRAINT projects_owner_id_fkey1 FOREIGN KEY (owner_id) REFERENCES public.profiles(id);
...
--
-- Name: project_members Delete own memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Delete own memberships" ON public.project_members FOR DELETE USING ((auth.uid() = user_id));


--
-- Name: projects Delete own projects; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: project_members Insert own memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Insert own memberships" ON public.project_members FOR INSERT WITH CHECK ((auth.uid() = user_id));
...
--
-- Name: projects Insert own projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Insert own projects" ON public.projects FOR INSERT WITH CHECK ((auth.uid() = owner_id));


--
-- Name: project_members Members can view memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Members can view memberships" ON public.project_members FOR SELECT USING ((project_id IN ( SELECT project_members_1.project_id
   FROM public.project_members project_members_1
  WHERE (project_members_1.user_id = auth.uid()))));


--
-- Name: task_assignees Members can view task assignees; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Members can view task assignees" ON public.task_assignees FOR SELECT USING ((task_id IN ( SELECT t.id
   FROM (public.tasks t
...
--
-- Name: project_members Only project owner can manage members; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Only project owner can manage members" ON public.project_members USING ((auth.uid() = ( SELECT projects.owner_id
   FROM public.projects
  WHERE (projects.id = project_members.project_id)))) WITH CHECK ((auth.uid() = ( SELECT projects.owner_id
   FROM public.projects
...
--
-- Name: task_assignees Project members can add assignees; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Project members can add assignees" ON public.task_assignees FOR INSERT WITH CHECK ((task_id IN ( SELECT t.id
   FROM (public.tasks t
     JOIN public.project_members pm ON ((pm.project_id = t.project_id)))
  WHERE (pm.user_id = auth.uid()))));
...
--
-- Name: tasks Project members can create tasks; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: tasks Project members can delete tasks; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Project members can delete tasks" ON public.tasks FOR DELETE USING ((project_id IN ( SELECT project_members.project_id
   FROM public.project_members
  WHERE (project_members.user_id = auth.uid()))));


--
-- Name: task_assignees Project members can remove assignees; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Project members can remove assignees" ON public.task_assignees FOR DELETE USING ((task_id IN ( SELECT t.id
   FROM (public.tasks t
     JOIN public.project_members pm ON ((pm.project_id = t.project_id)))
  WHERE (pm.user_id = auth.uid()))));
...
--
-- Name: task_assignees Project members can update assignees; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Project members can update assignees" ON public.task_assignees FOR UPDATE USING ((task_id IN ( SELECT t.id
   FROM (public.tasks t
     JOIN public.project_members pm ON ((pm.project_id = t.project_id)))
  WHERE (pm.user_id = auth.uid()))));
...
--
-- Name: tasks Project members can update tasks; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Project members can update tasks" ON public.tasks FOR UPDATE USING ((project_id IN ( SELECT project_members.project_id
   FROM public.project_members
  WHERE (project_members.user_id = auth.uid()))));


--
-- Name: projects Project owners can delete; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: projects Project owners can update; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: projects Projects are viewable by everyone; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: project_members Select own memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Select own memberships" ON public.project_members FOR SELECT USING ((auth.uid() = user_id));
...
--
-- Name: projects Select own projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Select own projects" ON public.projects FOR SELECT USING ((auth.uid() = owner_id));


--
-- Name: tasks Tasks are viewable by everyone; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: project_members Update own memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Update own memberships" ON public.project_members FOR UPDATE USING ((auth.uid() = user_id));
...
--
-- Name: projects Update own projects; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: project_members members can access their project membership; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "members can access their project membership" ON public.project_members FOR SELECT USING ((auth.uid() IN ( SELECT project_members_1.user_id
   FROM public.project_members project_members_1
...
--
-- Name: project_members select_members_in_my_projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY select_members_in_my_projects ON public.project_members FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.projects
  WHERE ((projects.id = project_members.project_id) AND (projects.owner_id = auth.uid())))));


--
-- Name: project_members select_own_memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY select_own_memberships ON public.project_members FOR SELECT USING ((auth.uid() = user_id));


--
-- Name: project_members users can see other members of their projects; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users can see other members of their projects" ON public.project_members FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.projects p
  WHERE ((p.id = project_members.project_id) AND ((p.owner_id = auth.uid()) OR (EXISTS ( SELECT 1
           FROM public.project_members pm2
          WHERE ((pm2.project_id = p.id) AND (pm2.user_id = auth.uid())))))))));


--
-- Name: project_members users can see their project memberships; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "users can see their project memberships" ON public.project_members FOR SELECT USING ((auth.uid() = user_id));
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.project_members TO anon;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.task_assignees TO anon;
...
\unrestrict MXd7CtGaCBZu8yVc5WzfS86HtaoabHu56yRASnaqdKZPWRuMlwgkbWRHVkCtAJT
